...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const summaryList = document.querySelector(
      ".package-features__summary > div:first-child ul"
    );
    const secondDiv = document.querySelector(
      ".package-features__summary > div:nth-child(2)"
    );
    const checksList = secondDiv
      ? secondDiv.querySelector("h4:not(.package-plus-section h4) ~ ul")
      : null;
    const summaryColorDiv = document.querySelector(
      ".package-features__summary > div:first-child"
    );
    ...
    function handlePackageClick(event) {
      ...
      if (packageSlug) {
        const bookNowButton = document.querySelector(
          ".package-cta .long-red-button"
        );
        const findOutMoreButton = document.querySelector(
          ".package-cta .long-outline-button"
        );
      ...
      if (packagePrice) {
        const ctaPriceElement = document.querySelector(
          ".package-cta .package-header__text h4"
        );
        if (ctaPriceElement) {
    ...
    mobileAccordionItems.forEach((item) => {
      ...
      header.addEventListener("click", function () {
        ...
        if (!isOpen) {
          ...
          const summaryList = content.querySelector(
            ".package-features__summary > div:first-child ul"
          );
          const summaryColorDiv = content.querySelector(
            ".package-features__summary > div:first-child"
          );
          const secondDiv = content.querySelector(
            ".package-features__summary > div:nth-child(2)"
          );
          const checksList = secondDiv
            ? secondDiv.querySelector("h4:not(.package-plus-section h4) ~ ul")
    ...
    const readMoreToggles = document.querySelectorAll(
    ...
    readMoreToggles.forEach((toggle) => {
      toggle.addEventListener("click", function (e) {
        ...
        const findMoreButton = accordionItem
          ? accordionItem.querySelector(".mobile-find-more")
          : null;

        if (
          detailsSection &&
          detailsSection.classList.contains("mobile-service-details")
        ) {
